...
function(get_arch_and_system_from_triple triple arch_var sys_var)
  ...
  elseif(target_arch MATCHES "^v810")
    set(target_arch "v810")
  elseif(target_arch MATCHES "^v830")
    set(target_arch "v830")
...
elseif(LIBC_TARGET_ARCHITECTURE STREQUAL "v810")
  set(LIBC_TARGET_ARCHITECTURE_IS_V810 TRUE)
elseif(LIBC_TARGET_ARCHITECTURE STREQUAL "v830")
  set(LIBC_TARGET_ARCHITECTURE_IS_V830 TRUE)
