...
public:
  ...
  void printBcondInstruction(const MCInst *MI, uint64_t Address, const MCSubtargetInfo &STI, raw_ostream &O);
  void printJmpInstruction(const MCInst *MI, uint64_t Address, const MCSubtargetInfo &STI, raw_ostream &O);
  ...
  template <unsigned N>
  void printBranchOperand(const MCInst *MI, uint64_t Address, unsigned opNum, const MCSubtargetInfo &STI, raw_ostream &OS);
  void printMemOperand(const MCInst *MI, int opNum, const MCSubtargetInfo &STI, raw_ostream &OS);
  void printCondOperand(const MCInst *MI, int opNum, const MCSubtargetInfo &STI, raw_ostream &OS);
};
