...
; RUN: opt < %s -passes=instcombine -instcombine-disable-v810-fix -S                         | FileCheck %s
; RUN: opt < %s -passes=instcombine -instcombine-disable-v810-fix -S -data-layout=n32        | FileCheck %s
; RUN: opt < %s -passes=instcombine -instcombine-disable-v810-fix -S -data-layout=n32:64     | FileCheck %s
; RUN: opt < %s -passes=instcombine -instcombine-disable-v810-fix -S -data-layout=n32:64:128 | FileCheck %s
