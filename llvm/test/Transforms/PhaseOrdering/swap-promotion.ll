...
; RUN: opt -instcombine-disable-v810-fix -S -O1 < %s | FileCheck %s
; RUN: opt -instcombine-disable-v810-fix -S -O2 < %s | FileCheck %s
; RUN: opt -instcombine-disable-v810-fix -S -O3 < %s | FileCheck %s
