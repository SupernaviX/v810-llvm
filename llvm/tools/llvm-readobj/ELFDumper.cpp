...
constexpr EnumStringDef<unsigned, 2> ElfV810SectionFlagsDefs[] = {
    ENUM_ENT(SHF_V810_GPREL, "")};
constexpr auto ElfV810SectionFlags =
    BUILD_ENUM_STRINGS(ElfV810SectionFlagsDefs);
